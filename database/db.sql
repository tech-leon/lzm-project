...
CREATE TABLE Income(
	...
	jobType	VARCHAR(15) NULL,
		CHECK (jobType IN ('FullTime', 'PartTime', 'Casual', 'OtherIncome', NULL)),
	position VARCHAR(50) NULL,
	location VARCHAR(200) NULL,
	startDate DATETIME NOT NULL,
	endDate DATETIME NULL,
	frequency VARCHAR(15) NOT NULL, CHECK (frequency
		IN ('OneTime','Weekly','Fornightly','Monthly','Quarterly','Seminannually','Annual')),
...
CREATE TABLE Salaries(
	...
	note TEXT NULL) AUTO_INCREMENT = 1001;
...
CREATE TABLE Categories(
	...
	categoryName VARCHAR(50) NOT NULL
		CHECK (categoryName IN ('Food', 'Education', 'Entertainment', 'Groceries',
		  'Health', 'Home', 'Shopping', 'SuperContributions', 'TaxPaid','Travel',
		  'Transfers', 'Transport', 'Utilities', 'Uncategorised'))) AUTO_INCREMENT = 3001;
...
CREATE TABLE Spendings(
	...
	spDateTime DATETIME	NOT NULL,
	amount INT NOT NULL,
	note TEXT NULL) AUTO_INCREMENT = 9001;
...
CREATE TABLE Goals(
	...
	amount INT NOT NULL,
	note TEXT NULL) AUTO_INCREMENT = 4001;
...
CREATE TABLE InvestType(
	...
	investType VARCHAR(50) NOT NULL, CHECK (investType
		IN ('Stock', 'Bond','Crypto', 'OtherInvestment'))
    ) AUTO_INCREMENT = 5001;
...
CREATE TABLE Investments(
	...
	investReturn INT NOT NULL DEFAULT 0,
	  CHECK (investReturn >= 0 AND investReturn <= 100)) AUTO_INCREMENT = 6001;
